...
graph TD
    ...
    Q1 -->|是| Q2{已有数据库?}
    Q1 -->|否| Cloud[Cloud Run 部署<br/>托管服务]
    
    Q2 -->|是| External[Docker 部署<br/>外部数据库]
    Q2 -->|否| Q3{需要数据持久化?}
    
    Q3 -->|是| Setup[先安装数据库]
    Q3 -->|否| Dev[开发环境<br/>docker-compose]
    
    Setup --> External
    
    External --> Doc1[📖 QUICKSTART.md]
    Cloud --> Doc2[📖 deployment-cloudrun.md]
    Dev --> Doc3[📖 README.md]
