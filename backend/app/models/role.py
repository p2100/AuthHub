...
class Role(Base):
    ...
    code = Column(String(100), unique=True, nullable=False, index=True, comment="角色代码: global:admin, system_a:editor")
    ...
    route_patterns = relationship("RoutePattern", back_populates="role", cascade="all, delete-orphan")
